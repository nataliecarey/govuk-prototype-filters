...
views.addFilter('xgovuk.isObject', isObject)
views.addFilter('xgovuk.objectToArray', objectToArray)

// Add backwards compatibility for non-namespaced filters

views.addFilter('isObject', deprecationWarning('isObject', isObject))
views.addFilter('objectToArray', deprecationWarning('objectToArray', objectToArray))
