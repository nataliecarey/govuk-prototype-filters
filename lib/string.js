...
views.addFilter('xgovuk.govukMarkdown', govukMarkdown)
views.addFilter('xgovuk.isString', isString)
views.addFilter('xgovuk.noOrphans', noOrphans)
views.addFilter('xgovuk.slugify', slugify)
views.addFilter('xgovuk.startsWith', startsWith)

// Add backwards compatibility for non-namespaced filters

views.addFilter('govukMarkdown', deprecationWarning('govukMarkdown', govukMarkdown))
views.addFilter('isString', deprecationWarning('isString', isString))
views.addFilter('noOrphans', deprecationWarning('noOrphans', noOrphans))
views.addFilter('slugify', deprecationWarning('slugify', slugify))
views.addFilter('startsWith', deprecationWarning('startsWith', startsWith))
