...
views.addFilter('xgovuk.duration', duration)
views.addFilter('xgovuk.govukDate', govukDate)
views.addFilter('xgovuk.govukTime', govukTime)
views.addFilter('xgovuk.isoDateFromDateInput', isoDateFromDateInput)
views.addFilter('xgovuk.monthName', monthName)

// Add backwards compatibility for non-namespaced filters

views.addFilter('duration', deprecationWarning('duration', duration))
views.addFilter('govukDate', deprecationWarning('govukDate', govukDate))
views.addFilter('govukTime', deprecationWarning('govukTime', govukTime))
views.addFilter('isoDateFromDateInput', deprecationWarning('isoDateFromDateInput', isoDateFromDateInput))
views.addFilter('monthName', deprecationWarning('monthName', monthName))
