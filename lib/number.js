...
views.addFilter('xgovuk.currency', currency)
views.addFilter('xgovuk.isNumber', isNumber)
views.addFilter('xgovuk.ordinal', ordinal)
views.addFilter('xgovuk.plural', plural)

// Add backwards compatibility for non-namespaced filters

views.addFilter('currency', deprecationWarning('currency', currency))
views.addFilter('isNumber', deprecationWarning('isNumber', isNumber))
views.addFilter('ordinal', deprecationWarning('ordinal', ordinal))
views.addFilter('plural', deprecationWarning('plural', plural))
